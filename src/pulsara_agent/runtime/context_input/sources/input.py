...
CONTEXT_SOURCE_INPUT_TYPES = {
    ...
    ContextSourceId.PLAN_STATUS: PlanSourceInput,
    ContextSourceId.PLAN_GUIDANCE: PlanSourceInput,
...
CONTEXT_SOURCE_PAYLOAD_TYPES = {
    ...
    ContextSourceId.PLAN_STATUS: PlanRevisionPayloadFact,
    ContextSourceId.PLAN_GUIDANCE: PlanRevisionPayloadFact,
