...
_RESOURCE_CHECKSUMS = (
    ...
    "6e20aae5256a2babdec2a0b23ebc5bc10320d75c4682abf22992ec3057f62091",
)
_NAMES = (
...
_AUXILIARY_RESOURCES: tuple[tuple[tuple[str, str], ...], ...] = (
    ...
    (
        (
            ...
            "a583544aeb551fcaf301f61d4781492930898d26e5f6cd60cc0c49f73bdc69a4",
        ),
    ),
)
