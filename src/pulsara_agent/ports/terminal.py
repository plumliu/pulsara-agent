...
TERMINAL_PROCESS_TOOL_DESCRIPTION = (
    ...
    "result; they do not send another update later. Avoid repeated polling without a new "
    "reason. For "
...
TERMINAL_MONITOR_TOOL_DESCRIPTION = (
    ...
    "limited; use terminal_process with action=log for more. After register, do not poll "
    "merely to wait. cancel stops later updates but does not stop the command; use "
