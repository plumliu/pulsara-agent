...
TERMINAL_PROCESS_TOOL_DESCRIPTION = (
    ...
    "was discarded; RETAINED_SNAPSHOT is only the part still available, not a full log. "
    "If a cursor is rejected, copy one from that process or omit since_cursor. "
