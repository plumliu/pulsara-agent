...
PYTHON_WORKSPACE_ROOT = Path("/Users/plumliu/Desktop/python_workspace")
...
def _create_python_workspace_temp_root(prefix: str = "pulsara-dogfood-pr4-small-") -> Path:
    PYTHON_WORKSPACE_ROOT.mkdir(parents=True, exist_ok=True)
    return Path(tempfile.mkdtemp(prefix=prefix, dir=PYTHON_WORKSPACE_ROOT))
